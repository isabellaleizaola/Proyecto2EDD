...
public class ReservationSearch extends javax.swing.JFrame {
     ...
     */
    public ReservationSearch(Tree reservationsTree, Tree roomsTree, Tree historyTree, HashTable hashTable) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReservationSearch( reservationsTree,  roomsTree,  historyTree,  hashTable).setVisible(true);
            }
        });
    }
