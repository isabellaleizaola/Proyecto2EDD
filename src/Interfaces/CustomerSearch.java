...
public class CustomerSearch extends javax.swing.JFrame {
     ...
     */
    public CustomerSearch(Tree reservationsTree, Tree roomsTree, Tree historyTree, HashTable hashTable) {
        initComponents();
    ...
    private void SearchClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchClientActionPerformed
        ...
        try {
            ...
            Client client = fc.CustomerSearch(name, lastName, hashTable);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerSearch( reservationsTree,  roomsTree,  historyTree,  hashTable).setVisible(true);
            }
        });
    }
