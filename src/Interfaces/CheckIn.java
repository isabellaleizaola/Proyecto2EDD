...
import FunctionalitiesSoftware.Checkin;
...
public class CheckIn extends javax.swing.JFrame {
     ...
     */
    public CheckIn(Tree reservationsTree, Tree roomsTree, Tree historyTree, HashTable hashTable) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(Register, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 210, -1, -1));
    ...
    private void RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterActionPerformed
        ...
        try {
            ...
            if (reservation1 == null) {
                ...
                Checkin checkI = new Checkin(hashTable, roomsTree, reservationsTree);
                
                JOptionPane.showMessageDialog(rootPane, checkI.ChekInCi(idnum, reservation1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CheckIn( reservationsTree,  roomsTree,  historyTree,  hashTable).setVisible(true);
            }
        });
    }
